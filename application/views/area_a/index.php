                            ...
                            <div class="my-dp-dash ">
                                <div class=" container-avatar">
                                    <div class="overlay-avatar-home" @click="openfile">
                                        <div class="icon-home-profile cursor-pointer" @click="showImg(img_profile,'#input-file-img-profile',true)">
                                ...
                                <div class=" container-avatar" >
                                    ...
                                    <div class="overlay-avatar-home">
                                        <div class="icon-home-profile cursor-pointer">
                                            <i class="far fa-eye home-profile" @click="showImg(img_profile,'#input-file-img-profile',true)"></i>
                                        </div>
                                    </div>
