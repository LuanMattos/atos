...
<head>
    ...
    <title>Goeveni - Privacy Policy</title>
    ...
    <link href="<?= URL_RAIZ() ?>application/assets/libs/vendor/OwlCarousel/assets/owl.theme.default.min.css" rel="stylesheet">s
        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="title-bar-text">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Política foda-se de privacidade</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="policy-heading text-center">
                            <h2>Política de privacidade</h2>
                        </div>
                        <div class="policy-text">
                            <p>Abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba </p>
                        </div>
                        <div class="policy-text-1">
                            <h4>Abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba?</h4>
                            <p>Abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba </p>
                        </div>
                        <div class="policy-text-1">
                            <h4>Abluba esclasache abluba esclasache abluba?</h4>
                            <ul>
                                <li>
                                    <h6>Abluba esclasache abluba esclasache abluba :</h6>
                                    <p>Abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba esclasache abluba </p>
                                </li>
                                <li>
                                    <h6>Abluba esclasache abluba esclasache abluba :</h6>
